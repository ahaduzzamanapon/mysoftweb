...
class Frontend_Controller extends MY_Controller
{
	function __construct()
	{
		...
		$this->data['header_service_categories'] = $this->Site_model->get_service_categories();
		$services = $this->Site_model->get_all_services(false);
		$this->data['header_services_grouped'] = [];
		if ($services) {
			foreach ($services as $s) {
				$this->data['header_services_grouped'][$s->main_service_id][] = $s;
			}
		}
