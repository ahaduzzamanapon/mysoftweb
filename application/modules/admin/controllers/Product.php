...
class Product extends Backend_Controller {
    ...
    /*
        UpdatedBy: Ismail At: 22-01-18
    */
    public function edit($id){

       $this->data['clients'] = $this->Common_model->get_client_dd(); 
        ...
        $this->form_validation->set_rules('demo_url', 'Demo Url', 'max_length[255]|trim'); //22-01-18 
        ...
        if ($this->form_validation->run() == true){
            ...
            $clients = implode(',', $this->input->post('user_client'));
            ...
            $form_data = array(
                ...
                'demo_url' => $this->input->post('demo_url')?$this->input->post('demo_url'):NULL        //22-01-18
            );
    ...
    */
	public function add(){
        $this->data['client'] = $this->Common_model->get_data('client'); 
