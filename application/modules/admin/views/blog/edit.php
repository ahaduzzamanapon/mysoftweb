          ...
          <div class="row">
            <div class="col-md-7">
              ...
              <div class="form-group">
                ...
                <textarea id="eventEdit" name="description" rows="10" cols="80"><?=set_value('description', $info->description)?></textarea>
              </div>
            </div>
...
ClassicEditor.create(document.querySelector('#eventEdit'))
    .then(editor => {
