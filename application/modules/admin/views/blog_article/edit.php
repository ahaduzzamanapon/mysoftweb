    ...
    <div class="col-md-12">
      <div class="box box-primary">
        <div class="box-header with-border">
          ...
          <a href="<?=base_url('admin/blog_article/all')?>" class="btn btn-info btn-xs pull-right" style="margin-left: 15px;"> All Blog Article</a>
          <a href="<?=base_url('admin/blog_article/details/'.$info->id)?>" class="btn btn-info btn-xs pull-right" style="margin-left: 15px;"> Details Blog Article</a>
          <a href="<?=base_url('admin/blog_article/add')?>" class="btn btn-info btn-xs pull-right"> Add Blog</a> 
        </div>        
        <?php echo form_open_multipart("admin/blog_article/edit/".$info->id);?>
        <div class="box-body">            
          ...
          <div class="row">
            <div class="col-md-7">
              ...
              <div class="form-group">
                ...
                <textarea id="blogEditdescription" name="description" rows="10" cols="80"><?=set_value('description', $info->description)?></textarea>
              </div>
            </div>
...
ClassicEditor.create(document.querySelector('#blogEditdescription'))
    .then(editor => {
