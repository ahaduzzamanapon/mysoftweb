                ...
                <td> 
                  <div class="btn-group">
                      ...
                      <ul class="dropdown-menu" role="menu">
                        <!-- <li><a href="<?=base_url('admin/client/details/'.$row->id)?>">Details</a></li> -->
                        <li><a href="<?=base_url('admin/client/edit/'.$row->id)?>">Edit</a></li>
                        <li><a href="<?=base_url('admin/client/delete/'.$row->id)?>" onclick="return confirm('Are you sure you want to delete this Client?');">Delete</a></li>
                      </ul>
                    </div>
                </td>
              </tr>
