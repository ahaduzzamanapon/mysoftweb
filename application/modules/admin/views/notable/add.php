                    ...
                    <div class="row">
                        <div class="col-md-7">
                            ...
                            <div class="form-group">
                                ...
                                <p class="help-block">File type jpg, png, jpeg, gif and maximun file size 3 MB.Crop Only Logo. width = 600px and height=600px</p>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="addNotable" class="form-control" name="description" rows="10" cols="80"><?= set_value('description') ?></textarea>
                            </div>
                        ...
                        <div class="col-md-5">
                            ...
                            <div class="form-group">
                                ...
                                <span>Image size width = 100px and height = 100px</span>
                            ...
                            <div class="form-group">
                                ...
                                <span>Image size width = 525px and height = 300px</span>
...
ClassicEditor.create(document.querySelector('#addNotable'))
    .then(editor => {
