            ...
            <div class="row">
              <div class="col-md-7">
                  ...
                  <div class="form-group">
                    ...
                    <textarea id="overviewAdd" name="overview" rows="10" cols="80"><?=set_value('overview')?></textarea>
                  </div>

                  <div class="form-group">
                    <label>Modules</label>
                    <div><?php echo form_error('modules'); ?></div>
                    <textarea id="modulesAdd" name="modules" rows="10" cols="80"><?=set_value('modules')?></textarea>
                  </div>

                  <div class="form-group">
                    <label>Features</label>
                    <div><?php echo form_error('features'); ?></div>
                    <textarea id="featuresAdd" name="features" rows="10" cols="80"><?=set_value('features')?></textarea>
                  </div>

                  <div class="form-group">
                    <label>Technology</label>
                    <div><?php echo form_error('technology'); ?></div>
                    <textarea id="technologyAdd" name="technology" rows="10" cols="80"><?=set_value('technology')?></textarea>
                  </div>
              ...
              <div class="col-md-5">
                ...
                <div class="form-group">
                  ...
                  <p class="help-block">File type jpg, png, jpeg, gif and maximun file size 1 MB.Image width=132px and height=132px.</p>
                </div>
...
ClassicEditor.create(document.querySelector('#overviewAdd'))
    .then(editor => {
...
ClassicEditor.create(document.querySelector('#modulesAdd'))
    .then(editor => {
        window.editor = editor;
    })
    .catch(error => {
...
ClassicEditor.create(document.querySelector('#featuresAdd'))
    .then(editor => {
        window.editor = editor;
    })
    .catch(error => {
...
ClassicEditor.create(document.querySelector('#technologyAdd'))
    .then(editor => {
        window.editor = editor;
    })
    .catch(error => {
