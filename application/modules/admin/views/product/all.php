                ...
                <td> 
                  <div class="btn-group">
                      ...
                      <ul class="dropdown-menu" role="menu">
                        <li><a href="<?=base_url('admin/product/details/'.$row->id)?>">Details</a></li>
                        <li><a href="<?=base_url('admin/product/edit/'.$row->id)?>">Edit</a></li>
                        <li><a href="<?=base_url('admin/product/delete/'.$row->id)?>" onclick="return confirm('Are you sure you want to delete this Product?');">Delete</a></li>
                      </ul>
                    </div>
                </td>
              </tr>
