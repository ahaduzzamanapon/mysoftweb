      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          ...
          <a href="<?= base_url('admin/services/all') ?>" class="btn btn-info btn-xs pull-right"
            style="margin-left: 15px;"> All Services</a>
        </div>
          ...
          <div class="row">
            <div class="col-md-7">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="main_name" value="<?= set_value('main_name') ?>">
              </div>
              ...
              <div class="form-group">
                ...
                <textarea class="form-control" rows="3" name="short_desc"
                  placeholder="Short Description Maximum 255 character"><?= set_value('short_desc') ?></textarea>
              </div>

              <div class="form-group">
                <label>Details Description</label>
                <div><?php echo form_error('description'); ?></div>
                <textarea id="serviceAdd" name="description" rows="10"
                  cols="80"><?= set_value('description') ?></textarea>
              </div>
            </div>
            ...
            <div class="col-md-5">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="fa_icon" value="<?= set_value('fa_icon', 'fa-tag') ?>"
                  placeholder="e.g. fa-camera-retro">
              </div>

              <div class="form-group">
                <label class="form-label required">Display Home</label> <br>
                <input type="radio" name="display_home" value="1"
                  <?= set_value('display_home') == '1' ? 'checked' : 'checked'; ?>> Yes
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="radio" name="is_published" value="1" <?=set_value('is_published')=='1'?'checked':'checked';?>> Yes 
                  <input type="radio" name="is_published" value="0" <?=set_value('is_published')=='0'?'checked':'';?>> No
                </div>
              ...
              <div class="form-group">
                ...
                <textarea class="form-control" rows="3" name="meta_keys"
                  placeholder="tag1, tag2, tag3, tag4, tag5"><?= set_value('meta_keys') ?></textarea>
              </div>
              <br><br><br>
            </div>
            <br><br><br>
            ...
            <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="first_section_title"
                  value="<?= set_value('first_section_title') ?>">
              </div>
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="first_section_para"
                  value="<?= set_value('first_section_para') ?>">
              </div>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="second_section_title"
                  value="<?= set_value('second_section_title') ?>">
              </div>
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="second_section_heading_one"
                  value="<?= set_value('second_section_heading_one') ?>">
              </div>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="second_section_heading_two"
                  value="<?= set_value('second_section_heading_two') ?>">
              </div>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="second_section_para_one"
                  value="<?= set_value('second_section_para_one') ?>">
              </div>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="second_section_para_two"
                  value="<?= set_value('second_section_para_two') ?>">
              </div>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="five_section_title"
                  value="<?= set_value('five_section_title') ?>">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="six_section_title"
                  value="<?= set_value('six_section_title') ?>">
              </div>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="six_section_para_one"
                  value="<?= set_value('six_section_para_one') ?>">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="six_section_para_two"
                  value="<?= set_value('six_section_para_two') ?>">
              </div>
              <!-- Seven Section -->
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="seven_section_title"
                  value="<?= set_value('seven_section_title') ?>">
              </div>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="seven_section_para_one"
                  value="<?= set_value('seven_section_para_one') ?>">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="seven_section_para_two"
                  value="<?= set_value('seven_section_para_two') ?>">
              </div>
              <br><br>
              <!-- Eight Section -->
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="eight_section_title"
                  value="<?= set_value('eight_section_title') ?>">
              </div>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="eight_section_icon_one"
                  value="<?= set_value('eight_section_icon_one') ?>" placeholder="Give your icon">
              </div>
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="eight_section_icon_two"
                  value="<?= set_value('eight_section_icon_two') ?>" placeholder="Give your icon">
              </div>
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="eight_section_icon_three"
                  value="<?= set_value('eight_section_icon_three') ?>" placeholder="Give your icon">
              </div>
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="eight_section_icon_four"
                  value="<?= set_value('eight_section_icon_four') ?>" placeholder="Give your icon">
              </div>
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="eight_section_icon_five"
                  value="<?= set_value('eight_section_icon_five') ?>" placeholder="Give your icon">
              </div>
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="eight_section_icon_six"
                  value="<?= set_value('eight_section_icon_six') ?>" placeholder="Give your icon">
              </div>
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="eight_section_heading_one"
                  value="<?= set_value('eight_section_heading_one') ?>">
              </div>
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="eight_section_para_one"
                  value="<?= set_value('eight_section_para_one') ?>">
              </div>
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="eight_section_heading_two"
                  value="<?= set_value('eight_section_heading_two') ?>">
              </div>
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="eight_section_para_two"
                  value="<?= set_value('eight_section_para_two') ?>">
              </div>
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="eight_section_heading_three"
                  value="<?= set_value('eight_section_heading_three') ?>">
              </div>
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="eight_section_para_three"
                  value="<?= set_value('eight_section_para_three') ?>">
              </div>
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="eight_section_heading_four"
                  value="<?= set_value('eight_section_heading_four') ?>">
              </div>
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="eight_section_para_four"
                  value="<?= set_value('eight_section_para_four') ?>">
              </div>
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="eight_section_heading_five"
                  value="<?= set_value('eight_section_heading_five') ?>">
              </div>
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="eight_section_para_five"
                  value="<?= set_value('eight_section_para_five') ?>">
              </div>
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="eight_section_heading_six"
                  value="<?= set_value('eight_section_heading_six') ?>">
              </div>
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="eight_section_para_six"
                  value="<?= set_value('eight_section_para_six') ?>">
              </div>
              <br><br>
              <!-- Nine Section -->
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="nine_section_title"
                  value="<?= set_value('nine_section_title') ?>">
              </div>
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="nine_section_main_para"
                  value="<?= set_value('nine_section_main_para') ?>">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="nine_section_heading_one"
                  value="<?= set_value('nine_section_heading_one') ?>">
              </div>
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="nine_section_para_one"
                  value="<?= set_value('nine_section_para_one') ?>">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="nine_section_heading_two"
                  value="<?= set_value('nine_section_heading_two') ?>">
              </div>
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="nine_section_para_two"
                  value="<?= set_value('nine_section_para_two') ?>">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="nine_section_heading_three"
                  value="<?= set_value('nine_section_heading_three') ?>">
              </div>
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="nine_section_para_three"
                  value="<?= set_value('nine_section_para_three') ?>">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="nine_section_heading_four"
                  value="<?= set_value('nine_section_heading_four') ?>">
              </div>
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="nine_section_para_four"
                  value="<?= set_value('nine_section_para_four') ?>">
              </div>
              <!-- Ten Section -->
              <div class="form-group">
                <label>Ten Section Title</label>
                <div><?php echo form_error('ten_section_title'); ?></div>
                <input type="text" class="form-control" name="ten_section_title"
                  value="<?= set_value('ten_section_title') ?>">
              </div>
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="ten_section_para_one"
                  value="<?= set_value('ten_section_para_one') ?>">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="ten_section_tag_one"
                  value="<?= set_value('ten_section_tag_one') ?>">
              </div>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="ten_section_tag_two"
                  value="<?= set_value('ten_section_tag_two') ?>">
              </div>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="ten_section_tag_three"
                  value="<?= set_value('ten_section_tag_three') ?>">
              </div>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="ten_section_tag_four"
                  value="<?= set_value('ten_section_tag_four') ?>">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="ten_section_tag_five"
                  value="<?= set_value('ten_section_tag_five') ?>">
              </div>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="ten_section_tag_six"
                  value="<?= set_value('ten_section_tag_six') ?>">
              </div>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="ten_section_tag_seven"
                  value="<?= set_value('ten_section_tag_seven') ?>">
              </div>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="ten_section_tag_eight"
                  value="<?= set_value('ten_section_tag_eight') ?>">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="ten_section_tag_nine"
                  value="<?= set_value('ten_section_tag_nine') ?>">
              </div>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="ten_section_tag_ten"
                  value="<?= set_value('ten_section_tag_ten') ?>">
              </div>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="ten_section_tag_eleven"
                  value="<?= set_value('ten_section_tag_eleven') ?>">
              </div>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="ten_section_tag_twelve"
                  value="<?= set_value('ten_section_tag_twelve') ?>">
              </div>
              <br>
              <!-- Nineteen Section -->
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="nineteen_section_title"
                  value="<?= set_value('nineteen_section_title') ?>">
              </div>
              <div class="form-group">
            ...
            <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="third_section_title"
                  value="<?= set_value('third_section_title') ?>">
              </div>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="third_section_para_one"
                  value="<?= set_value('third_section_para_one') ?>">
              </div>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="third_section_para_two"
                  value="<?= set_value('third_section_para_two') ?>">
              </div>
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="third_section_para_three"
                  value="<?= set_value('third_section_para_three') ?>">
              </div>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="third_section_para_four"
                  value="<?= set_value('third_section_para_four') ?>">
              </div>
              <br><br><br><br>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="fourth_section_title"
                  value="<?= set_value('fourth_section_title') ?>">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="fourth_section_para_one"
                  value="<?= set_value('fourth_section_para_one') ?>">
              </div>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="fourth_section_para_two"
                  value="<?= set_value('fourth_section_para_two') ?>">
              </div>
              <br><br>
              <!-- Eleven Section -->
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="eleven_section_title"
                  value="<?= set_value('eleven_section_title') ?>">
              </div>
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="eleven_section_para"
                  value="<?= set_value('eleven_section_para') ?>">
              </div>
              <br><br>
              <!-- Twelve section -->
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="twelve_section_title"
                  value="<?= set_value('twelve_section_title') ?>">
              </div>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="thirteen_section_title"
                  value="<?= set_value('thirteen_section_title') ?>">
              </div>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="thirteen_section_tag_one"
                  value="<?= set_value('thirteen_section_tag_one') ?>">
              </div>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="thirteen_section_tag_two"
                  value="<?= set_value('thirteen_section_tag_two') ?>">
              </div>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="thirteen_section_tag_three"
                  value="<?= set_value('thirteen_section_tag_three') ?>">
              </div>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="thirteen_section_tag_four"
                  value="<?= set_value('thirteen_section_tag_four') ?>">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="thirteen_section_tag_five"
                  value="<?= set_value('thirteen_section_tag_five') ?>">
              </div>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="thirteen_section_tag_six"
                  value="<?= set_value('thirteen_section_tag_six') ?>">
              </div>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="thirteen_section_tag_seven"
                  value="<?= set_value('thirteen_section_tag_seven') ?>">
              </div>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="thirteen_section_tag_eight"
                  value="<?= set_value('thirteen_section_tag_eight') ?>">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="thirteen_section_tag_nine"
                  value="<?= set_value('thirteen_section_tag_nine') ?>">
              </div>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="thirteen_section_tag_ten"
                  value="<?= set_value('thirteen_section_tag_ten') ?>">
              </div>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="thirteen_section_tag_eleven"
                  value="<?= set_value('thirteen_section_tag_eleven') ?>">
              </div>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="thirteen_section_tag_twelve"
                  value="<?= set_value('thirteen_section_tag_twelve') ?>">
              </div>
              <br><br>
              <!-- Fourteen section -->
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="fourteen_section_title"
                  value="<?= set_value('fourteen_section_title') ?>">
              </div>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="fourteen_section_heading_one"
                  value="<?= set_value('fourteen_section_heading_one') ?>">
              </div>
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="fourteen_section_para_one"
                  value="<?= set_value('fourteen_section_para_one') ?>">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="fourteen_section_heading_two"
                  value="<?= set_value('fourteen_section_heading_two') ?>">
              </div>
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="fourteen_section_para_two"
                  value="<?= set_value('fourteen_section_para_two') ?>">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="fourteen_section_heading_three"
                  value="<?= set_value('fourteen_section_heading_three') ?>">
              </div>
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="fourteen_section_para_three"
                  value="<?= set_value('fourteen_section_para_three') ?>">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="fourteen_section_heading_four"
                  value="<?= set_value('fourteen_section_heading_four') ?>">
              </div>
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="fourteen_section_para_four"
                  value="<?= set_value('fourteen_section_para_four') ?>">
              </div>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="fifteen_section_title"
                  value="<?= set_value('fifteen_section_title') ?>">
              </div>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="sixteen_section_title"
                  value="<?= set_value('sixteen_section_title') ?>">
              </div>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="sixteen_section_heading_one"
                  value="<?= set_value('sixteen_section_heading_one') ?>">
              </div>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="sixteen_section_para_one"
                  value="<?= set_value('sixteen_section_para_one') ?>">
              </div>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="sixteen_section_heading_two"
                  value="<?= set_value('sixteen_section_heading_two') ?>">
              </div>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="sixteen_section_para_two"
                  value="<?= set_value('sixteen_section_para_two') ?>">
              </div>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="sixteen_section_heading_three"
                  value="<?= set_value('sixteen_section_heading_three') ?>">
              </div>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="sixteen_section_para_three"
                  value="<?= set_value('sixteen_section_para_three') ?>">
              </div>
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="sixteen_section_role_one"
                  value="<?= set_value('sixteen_section_role_one') ?>">
              </div>
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="sixteen_section_role_two"
                  value="<?= set_value('sixteen_section_role_two') ?>">
              </div>
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="sixteen_section_role_three"
                  value="<?= set_value('sixteen_section_role_three') ?>">
              </div>
              <br>
              <!-- Seventeen Section -->
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="seventeen_section_title"
                  value="<?= set_value('seventeen_section_title') ?>">
              </div>
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="seventeen_section_question_one"
                  value="<?= set_value('seventeen_section_question_one') ?>">
              </div>
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="seventeen_section_question_two"
                  value="<?= set_value('seventeen_section_question_two') ?>">
              </div>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="seventeen_section_question_three"
                  value="<?= set_value('seventeen_section_question_three') ?>">
              </div>
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="seventeen_section_question_four"
                  value="<?= set_value('seventeen_section_question_four') ?>">
              </div>
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="seventeen_section_question_five"
                  value="<?= set_value('seventeen_section_question_five') ?>">
              </div>
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="seventeen_section_question_six"
                  value="<?= set_value('seventeen_section_question_six') ?>">
              </div>
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="seventeen_section_answer_one"
                  value="<?= set_value('seventeen_section_answer_one') ?>">
              </div>
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="seventeen_section_answer_two"
                  value="<?= set_value('seventeen_section_answer_two') ?>">
              </div>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="seventeen_section_answer_three"
                  value="<?= set_value('seventeen_section_answer_three') ?>">
              </div>
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="seventeen_section_answer_four"
                  value="<?= set_value('seventeen_section_answer_four') ?>">
              </div>
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="seventeen_section_answer_five"
                  value="<?= set_value('seventeen_section_answer_five') ?>">
              </div>
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="seventeen_section_answer_six"
                  value="<?= set_value('seventeen_section_answer_six') ?>">
              </div>
              <br>
              <!-- Eighteen Section -->
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="eighteen_section_title"
                  value="<?= set_value('eighteen_section_title') ?>">
              </div>
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="eighteen_section_para"
                  value="<?= set_value('eighteen_section_para') ?>">
              </div>
