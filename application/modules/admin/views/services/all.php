    ...
    <div class="col-md-12">
      <div class="box box-primary">
        <div class="box-header with-border">
          ...
          <a href="<?=base_url('admin/services/add')?>" class="btn btn-info btn-xs pull-right"> Add Services</a>          
        </div>        
                ...
                <td> 
                  <div class="btn-group">
                      ...
                      <ul class="dropdown-menu" role="menu">
                        <li><a href="<?=base_url('admin/services/details/'.$row->id)?>">Details</a></li>
                        <li><a href="<?=base_url('admin/services/edit/'.$row->id)?>">Edit</a></li>
                        <li><a href="<?=base_url('admin/services/delete/'.$row->id)?>" onclick="return confirm('Are you sure you want to delete this service?');">Delete</a></li>
                      </ul>
                    </div>
                </td>
              </tr>
