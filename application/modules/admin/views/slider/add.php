    ...
    <div class="col-md-12">
      <div class="box box-primary">
        <div class="box-header with-border">
          ...
          <a href="<?=base_url('admin/slider/all')?>" class="btn btn-info btn-xs pull-right" style="margin-left: 15px;"> All Slider</a>          
        </div>        
            ...
            <div class="row">
              <div class="col-md-7">
                  ...
                  <div class="form-group">
                      ...
                      <p class="help-block">File type jpg, png, jpeg, gif and maximun file size 1 MB.Image size height=338px,width=338px</p>
                    </div>
              </div>
