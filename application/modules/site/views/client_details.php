	...
	<div class="container">
		...
		<?php if($this->uri->segment(2) == 'rmg-sector'){ ?>
					<table class="tg" id="data-body-rmg">
						<tr>
							...
							<th class="tg-5fsu" style="text-align: left">Project Name</th>
							<th class="tg-5fsu" style="text-align: left">Client Name</th>
							<th class="tg-5fsu" style="text-align: left">Location</th>
		...
		elseif($this->uri->segment(2) == 'education-sector'){ ?>
				...
				<table class="tg" id="data-body-edu">
					<tr>
						<th class="tg-5fsu" width="50">SL</th>
						<th class="tg-5fsu" style="text-align: left">School/College Name</th>
						<th class="tg-5fsu" style="text-align: left">Location</th>
						<th class="tg-5fsu">Logo</th>
					</tr>
