...
<style>
    ...
    .metric-bubble:nth-child(3) h3,
    .metric-bubble:nth-child(3) span {
        color: white;
    }
    ...
    <?php if (isset($product) && !empty($product)): 
        ...
        <!-- <section class="section-padding text-center" style="background: #0f172a; color: white;">
            <div class="container">
                ...
                <p style="color: #94a3b8; margin-bottom: 40px; font-size: 1.2rem;">Join thousands of satisfied customers
                    using our solution today.</p>
                <a href="<?php echo base_url('contact-us'); ?>" class="btn-premium"
                    style="background: white; color: #0f172a;">Request Free Demo</a>
            </div>
        </section> -->
