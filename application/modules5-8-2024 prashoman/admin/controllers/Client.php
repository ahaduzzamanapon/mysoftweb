...
class Client extends Backend_Controller {
    ...
    public function details($id){
        ...
        $this->data['meta_title'] = 'Client Details';
        $this->data['subview'] = 'client/details';
        $this->load->view('backend/_layout_main', $this->data);
    }
    ...
    public function edit($id){
        ...
        $this->data['types'] = array('' => '-- Select Client Type -- ', 'government-sector' => 'Government Sector', 'private-sector' => 'Private Sector', 'education-sector' => 'Education Sector', 'offshore-client' => 'Offshore Client', 'rmg-sector' => 'RMG Sector');
