...
class Setting extends Backend_Controller {
    ...
    public function edit($id){
        ...
        $this->form_validation->set_rules('video_link', 'Video Link description', 'trim', 'years_of_experience', 'number_of_clients', 'successful_projects','running_services');
        ...
        if ($this->form_validation->run() == true){
            ...
            $form_data = array(
                ...
                'number_of_clients' => $this->input->post('number_of_clients'),
                'successful_projects' => $this->input->post('successful_projects'),
                'running_services' => $this->input->post('running_services'),
            );
        ...
        $this->data['subview'] = 'settings/edit';
