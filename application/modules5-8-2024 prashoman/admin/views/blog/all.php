                ...
                <td> 
                  <div class="btn-group">
                      ...
                      <ul class="dropdown-menu" role="menu">
                        <li><a href="<?=base_url('admin/blog/details/'.$row->id)?>">Details</a></li>
                        <li><a href="<?=base_url('admin/blog/edit/'.$row->id)?>">Edit</a></li>
                        <li><a href="<?=base_url('admin/blog/delete/'.$row->id)?>" onclick="return confirm('Are you sure you want to delete this blog?');">Delete</a></li>
                      </ul>
                    </div>
                </td>
              </tr>
