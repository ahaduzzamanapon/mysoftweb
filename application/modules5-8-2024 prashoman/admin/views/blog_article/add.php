    ...
    <div class="col-md-12">
      <div class="box box-primary">
        <div class="box-header with-border">
          ...
          <a href="<?=base_url('admin/blog/all')?>" class="btn btn-info btn-xs pull-right" style="margin-left: 15px;"> All Blog Article</a>          
        </div>        
        <?php echo form_open_multipart("admin/blog_article/add");?>
        <div class="box-body">
          ...
          <div class="row">
            <div class="col-md-7">
              ...
              <div class="form-group">
                ...
                <textarea id="description" name="description" rows="10" cols="80"><?=set_value('description')?></textarea>
              </div>
            </div>
