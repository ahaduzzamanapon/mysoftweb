    ...
    <div class="col-md-12">
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Details Blog Article</h3>
          <a href="<?=base_url('admin/blog_article/edit/'.$info->id)?>" class="btn btn-info btn-xs pull-right" style="margin-left: 15px;"> Edit Blog Article</a>          
        </div>        
          <div class="box-body">
