          ...
          <div class="box-body">
            ...
            <table id="example1" class="table table-bordered table-striped table-responsive">
              ...
              <tr>
                ...
                <td><?=$row->email;?></td>
                <td><?=$row->subject;?></td>                
                <td><?= strlen($row->message) > 100 ? substr($row->message, 0, 100) . '...' : $row->message; ?></td>
                ...
                <td> 
                  <div class="btn-group">
                      ...
                      <ul class="dropdown-menu" role="menu">
                        ...
                        <li><a href="<?=base_url('admin/manage_contact/delete/'.$row->id)?>" onclick="return confirm('Are you sure you want to delete this Contact?');">Delete</a></li>
                      </ul>
                    </div>
                </td>
              </tr>
