    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-primary">
                ...
                <?php echo form_open_multipart("admin/image_gallery/add"); ?>
                <div class="box-body">
                    ...
                    <div class="row">
                        <div class="col-md-7">
                            ...
                            <div class="form-group">
                                ...
                                <p class="help-block">File type jpg, png, jpeg, gif and maximun file size 1 MB. width=547px and height = 357px.</p>
                            </div>
