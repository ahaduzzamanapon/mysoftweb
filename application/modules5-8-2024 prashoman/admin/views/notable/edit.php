                    ...
                    <div class="row">
                        <div class="col-md-7">
                            ...
                            <div class="form-group">
                                ...
                                <div>
                                <img width="50px" height="50px" src="<?= base_url('notable_img/').$info->notable_logo?>" alt="">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div>
                                <img width="50px" height="50px" src="<?= base_url('notable_img/').$info->image?>" alt="">
                                </div>
                        ...
                        <div class="col-md-5">
                            ...
                            <div class="form-group">
                                ...
                                if(count($client_data)>0){
                                    ...
                                    <tr style="border-bottom:1px solid blue;">
                                        ...
                                        <td>
                                            <input type="text" class="form-control" name="client_name[]" value="<?= set_value('client_name', $client->name) ?>">
                                        </td>
                                    </tr>
                            ...
                            <div class="form-group">
                                ...
                                <table class="table" id="availablePlatfromInfo">
                                    ...
                                    <tr style="border-bottom:1px solid blue;">
                                        ...
                                        <td>
                                            <input type="text" class="form-control" name="platfrom_link[]" value="<?= set_value('platfrom_link', $avilabe_platfrom->name) ?>">
                                        </td>
                                    </tr>
                            ...
                            <div class="form-group">
                                ...
                                <?php
                                    ...
                                    <?php
                                    if(count($aword_info)>0){
                    
                                    foreach($aword_info as $aword_info){
                                    ?>
                                    ...
                                    <tr style="border-bottom:1px solid blue;">
                                        ...
                                        <!-- <input type="text" class="form-control" name="aword_name[]"> -->
                                            <input type="text" class="form-control" name="aword_name[]" value="<?= set_value('aword_link', $aword_info->name) ?>">
                                        </td>
                                    </tr>
