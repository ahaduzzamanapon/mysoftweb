                ...
                <td> 
                  <div class="btn-group">
                      ...
                      <ul class="dropdown-menu" role="menu">
                        <li><a href="<?=base_url('admin/portfolio/details/'.$row->id)?>">Details</a></li>
                        <li><a href="<?=base_url('admin/portfolio/edit/'.$row->id)?>">Edit</a></li>
                        <li><a href="<?=base_url('admin/portfolio/delete/'.$row->id)?>" onclick="return confirm('Are you sure you want to delete this Portfolio?');">Delete</a></li>
                      </ul>
                    </div>
                </td>
              </tr>
