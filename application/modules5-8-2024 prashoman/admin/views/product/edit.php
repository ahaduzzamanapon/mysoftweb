            ...
            <div class="row">
              <div class="col-md-7">
                  ...
                  <div class="form-group">
                    ...
                    <textarea id="editor2" name="modules" rows="10" cols="80"><?=set_value('modules',$info->modules)?></textarea>
                  </div>

                  <div class="form-group">
                    <label>Features</label>
                    <div><?php echo form_error('features'); ?></div>
                    <textarea id="editor3" name="features" rows="10" cols="80"><?=set_value('features',$info->features)?></textarea>
                  </div>

                  <div class="form-group">
                    <label>Technology</label>
                    <div><?php echo form_error('technology'); ?></div>
                    <textarea id="editor4" name="technology" rows="10" cols="80"><?=set_value('technology',$info->technology)?></textarea>
                  </div>
              </div>
