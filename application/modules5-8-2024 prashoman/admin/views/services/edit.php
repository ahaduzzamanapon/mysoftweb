    ...
    <div class="col-md-12">
      <div class="box box-primary">
        <div class="box-header with-border">
          ...
          <a href="<?=base_url('admin/services/all')?>" class="btn btn-info btn-xs pull-right" style="margin-left: 15px;"> All Service</a>
          <a href="<?=base_url('admin/services/details/'.$info->id)?>" class="btn btn-info btn-xs pull-right" style="margin-left: 15px;"> Details Service</a>
          <a href="<?=base_url('admin/services/add')?>" class="btn btn-info btn-xs pull-right"> Add Service</a> 
        </div>        
