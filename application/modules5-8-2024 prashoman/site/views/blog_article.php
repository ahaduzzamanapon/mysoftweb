...
.blog-posts article {
    ...
    margin-bottom: 50px;
    box-shadow: inset 0px 0px 6px 1px #bab9b9;
    border-radius: 10px;
    padding: 18px;
    transform: scale(1);
...
<div role="main" class="main">
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-9">
				<div class="blog-posts" id='data-body'>
...
<script>
    ...
    $(document).ready(function() {
        ...
        function load_data() {
            ...
            $.ajax({
                url: "<?php echo base_url('site/blog_article_ajax/'); ?>" + page,
                method: "GET",
                success: function(data) {
					...
					if (data == false) {
						...
						$('#data-body').append(data).slideDown();
						page++;
