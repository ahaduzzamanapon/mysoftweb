          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown user user-menu">
              <a href="javascript:void();" class="dropdown-toggle" data-toggle="dropdown">
                ...
                <span
                  class="hidden-xs"><?= ucwords($this->session->userdata('first_name') . ' ' . $this->session->userdata('last_name')); ?></span>
              </a>
              <ul class="dropdown-menu">
                <li class="user-header">
                  <img src="<?= base_url(); ?>awedget/assets/img/no-avatar.jpeg" class="img-circle" alt="User Image">
                  <p><small>Member since
                      <strong><?= date('j F, Y', $this->session->userdata('created_on')); ?></strong></small> </p>
                </li>
        ...
        <ul class="sidebar-menu">
          ...
          <?php if (ifcan('event')): ?>
            <li class="treeview <?= backend_activate_menu_class('blog'); ?>">
              <a href="javascript:void();">
                <i class="fa fa-dashboard"></i> <span>Event</span> <span class="pull-right-container"> <i
          ...
          <?php if (ifcan('blog')): ?>
            ...
            <li class="treeview <?= backend_activate_menu_class('blog_article'); ?>">
              <a href="javascript:void();">
                <i class="fa fa-dashboard"></i> <span>Blog Article</span> <span class="pull-right-container"> <i
                    class="fa fa-angle-left pull-right"></i> </span>
              </a>
              <ul class="treeview-menu">
            ...
            <li class="treeview <?= backend_activate_menu_class('pages'); ?>">
              <a href="javascript:void();">
                <i class="fa fa-dashboard"></i> <span>Pages</span> <span class="pull-right-container"> <i
                    class="fa fa-angle-left pull-right"></i> </span>
              </a>
              <ul class="treeview-menu">
          ...
          <?php if (ifcan('portfolio')): ?>
            <li class="treeview <?= backend_activate_menu_class('portfolio'); ?>">
              <a href="javascript:void();">
                <i class="fa fa-dashboard"></i> <span>Portfolio</span> <span class="pull-right-container"> <i
                    class="fa fa-angle-left pull-right"></i> </span>
              </a>
              <ul class="treeview-menu">
          ...
          <?php if (ifcan('services')): ?>
            <li class="treeview <?= backend_activate_menu_class('services'); ?>">
              <a href="javascript:void();">
                <i class="fa fa-dashboard"></i> <span>Services</span> <span class="pull-right-container"> <i
                    class="fa fa-angle-left pull-right"></i> </span>
              </a>
              <ul class="treeview-menu">
          ...
          <?php if (ifcan('product')): ?>
            <li class="treeview <?= backend_activate_menu_class('product'); ?>">
              <a href="javascript:void();">
                <i class="fa fa-dashboard"></i> <span>Product</span> <span class="pull-right-container"> <i
                    class="fa fa-angle-left pull-right"></i> </span>
              </a>
              <ul class="treeview-menu">
          ...
          <?php if (ifcan('product')): // Reusing product permission for new product management ?>
            <li class="treeview <?= backend_activate_menu_class('product_new'); ?>">
              <a href="javascript:void();">
                <i class="fa fa-star"></i> <span>Products (New Design)</span> <span class="pull-right-container"> <i
                    class="fa fa-angle-left pull-right"></i> </span>
              </a>
              <ul class="treeview-menu">
          ...
          <?php if (ifcan('client')): ?>
            <li class="treeview <?= backend_activate_menu_class('client'); ?>">
              <a href="javascript:void();">
                <i class="fa fa-dashboard"></i> <span>Client</span> <span class="pull-right-container"> <i
                    class="fa fa-angle-left pull-right"></i> </span>
              </a>
              <ul class="treeview-menu">
          ...
          <?php if (ifcan('slider')): ?>
            <li class="treeview <?= backend_activate_menu_class('slider'); ?>">
              <a href="javascript:void();">
                <i class="fa fa-dashboard"></i> <span>Slider</span> <span class="pull-right-container"> <i
                    class="fa fa-angle-left pull-right"></i> </span>
              </a>
              <ul class="treeview-menu">
          ...
          <?php if (ifcan('image-gallery')): ?>
            <li class="treeview <?= backend_activate_menu_class('image_gallery'); ?>">
              <a href="javascript:void();">
                <i class="fa fa-dashboard"></i> <span>Image Gallery</span> <span class="pull-right-container"> <i
                    class="fa fa-angle-left pull-right"></i> </span>
              </a>
              <ul class="treeview-menu">
          ...
          <?php if (ifcan('image-gallery')): // Using image-gallery permission for now ?>
            <li class="treeview <?= backend_activate_menu_class('relationship_gallery'); ?>">
              <a href="javascript:void();">
                <i class="fa fa-camera"></i> <span>Relationship Gallery</span> <span class="pull-right-container"> <i
                    class="fa fa-angle-left pull-right"></i> </span>
              </a>
              <ul class="treeview-menu">
                <li><a href="<?= base_url('admin/relationship_gallery/add'); ?>"><i class="fa fa-circle-o"></i> Add
                    Image</a></li>
                <li><a href="<?= base_url('admin/relationship_gallery/all'); ?>"><i class="fa fa-circle-o"></i> All
                    Images</a></li>
              </ul>
            </li>
          <?php endif; ?>
          ...
          <?php if (ifcan('notable-project')): ?>
            <li class="treeview <?= backend_activate_menu_class('notable'); ?>">
              <a href="javascript:void();">
                <i class="fa fa-dashboard"></i> <span>Notable Project</span> <span class="pull-right-container"> <i
                    class="fa fa-angle-left pull-right"></i> </span>
              </a>
              <ul class="treeview-menu">
          ...
          <?php if (ifcan('role-permission')): ?>
            <li class="treeview <?= backend_activate_menu_class('Role_Permission'); ?>">
              <a href="javascript:void();">
                <i class="fa fa-dashboard"></i> <span>Role Permission</span> <span class="pull-right-container"> <i
                    class="fa fa-angle-left pull-right"></i> </span>
              </a>
              <ul class="treeview-menu">
                <li><a href="<?= base_url('admin/Role_Permission/all'); ?>"><i class="fa fa-circle-o"></i> Permission User
                    List </a></li>
                <!-- <li><a href="<?= base_url('admin/notable/add'); ?>"><i class="fa fa-circle-o"></i> Notable Add</a></li> -->
                <!-- <li><a href="<?= base_url('admin/manage_user/add'); ?>"><i class="fa fa-circle-o"></i> Add Notable</a></li> -->
              </ul>
          ...
          <?php if (ifcan('testimonial')): ?>
            <li class="treeview <?= backend_activate_menu_class('testimonial'); ?>">
              <a href="javascript:void();">
                <i class="fa fa-dashboard"></i> <span>Testimonial</span> <span class="pull-right-container"> <i
                    class="fa fa-angle-left pull-right"></i> </span>
              </a>
              <ul class="treeview-menu">
                <li><a href="<?= base_url('admin/testimonial/add'); ?>"><i class="fa fa-circle-o"></i> Add Testimonial</a>
                </li>
                <li><a href="<?= base_url('admin/testimonial/all'); ?>"><i class="fa fa-circle-o"></i> All Testimonial</a>
                </li>
              </ul>
            </li>
          <?php endif; ?>
          ...
          <?php if (ifcan('testimonial')): ?>
            <li class="treeview <?= backend_activate_menu_class('script'); ?>">
              <a href="javascript:void();">
                <i class="fa fa-dashboard"></i> <span>Script add</span> <span class="pull-right-container"> <i
                    class="fa fa-angle-left pull-right"></i> </span>
              </a>
              <ul class="treeview-menu">
          ...
          <?php if (ifcan('setting')): ?>
            <li class="treeview <?= backend_activate_menu_class('setting'); ?>">
              <a href="javascript:void();">
                <i class="fa fa-dashboard"></i> <span>Setting</span> <span class="pull-right-container"> <i
                    class="fa fa-angle-left pull-right"></i> </span>
              </a>
              <ul class="treeview-menu">
          ...
          <?php if (ifcan('manage-permission')): ?>
            <li class="treeview <?= backend_activate_menu_class(''); ?>">
              <a href="javascript:void();">
                <i class="fa fa-dashboard"></i> <span>Manage Permission</span> <span class="pull-right-container"> <i
                    class="fa fa-angle-left pull-right"></i> </span>
              </a>
              <ul class="treeview-menu">
          ...
          <?php if (ifcan('manage-contact')): ?>
            <li class="treeview <?= backend_activate_menu_class('manage_contact'); ?>">
              <a href="javascript:void();">
                <i class="fa fa-dashboard"></i> <span>Manage Contact</span> <span class="pull-right-container"> <i
                    class="fa fa-angle-left pull-right"></i> </span>
              </a>
              <ul class="treeview-menu">

                <li><a href="<?= base_url('admin/manage_contact/all'); ?>"><i class="fa fa-circle-o"></i> All Contact
                    Manage</a></li>
              </ul>
            </li>
          <?php endif; ?>
          ...
          <?php if (ifcan('manage-users')): ?>
            <li class="treeview <?= backend_activate_menu_class('manage_user'); ?>">
              <a href="javascript:void();">
                <i class="fa fa-dashboard"></i> <span>Manage Users</span> <span class="pull-right-container"> <i
                    class="fa fa-angle-left pull-right"></i> </span>
              </a>
              <ul class="treeview-menu">
          ...
          <?php if (ifcan('demu-request')): ?>
            <li class="<?= backend_activate_menu_class('request'); ?>"><a
                href="<?php echo base_url('admin/request/demo_request'); ?>"><i class="fa fa-paper-plane"></i> <span> Demo
                  Request</span></a></li>
          <?php endif; ?>
          ...
          <?php if (ifcan('change-password')): ?>
            <li class="<?= backend_activate_menu_class('change_password'); ?>"><a
                href="<?php echo base_url('change_password'); ?>"><i class="fa fa-book"></i> <span>Change
                  Password</span></a></li>
          <?php endif; ?>
