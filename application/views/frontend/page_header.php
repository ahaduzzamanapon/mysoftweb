                ...
                <div class="container">
                    ...
                    <nav class="nav-main mega-menu">
                        <ul class="nav nav-pills nav-main" id="mainMenu">
                            ...
                            Contact</a> </li>
                            <li class="<?= activate_menu_method('it-staffing-agency') ?>"> <a href="<?= base_url('it-staffing-agency') ?>" style="border: 1px solid #1e92d6;border-radius: 20px;padding: 1px 13px;font-family: 'Nourd-Medium';font-weight: 500;font-size: 13px;margin-top: 4px;"></i> Hire Talent</a> 
                        </li>
