      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview <?=backend_activate_menu_class('blog');?>">
          <a href="javascript:void();">
            <i class="fa fa-dashboard"></i> <span>Blog</span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="<?=base_url('admin/blog/add');?>"><i class="fa fa-circle-o"></i> Add Blog</a></li>
            <li><a href="<?=base_url('admin/blog/all');?>"><i class="fa fa-circle-o"></i> All Blog</a></li>
          </ul>
        </li>   
