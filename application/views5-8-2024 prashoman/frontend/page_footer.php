    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-10 pull-right">
          <p>© Copyright <?= date('Y') ?> | Mysoftheaven (BD) Ltd. | All Rights Reserved | <a href="<?= base_url('our-team-member') ?>">Our team member</a> | <a href="<?= base_url() ?>privacy-policy" target="_blank"> Privacy Policy </a> |<a href="<?= base_url() ?>terms" target="_blank"> Terms & Conditions </a></p>
        </div>
      </div>
    </div>
  </div>
